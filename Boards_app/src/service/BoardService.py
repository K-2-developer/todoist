...
from Boards_app.src.repository.interfaces.Board_interface import *
...
class BoardService:
    ...
    async def create_board(self, data: BoardCreate) -> BoardResponse:
        ...
        return await self.board.create(data)

    async def update_board(self, board_id: UUID, data: BoardUpdate) -> BoardResponse:
